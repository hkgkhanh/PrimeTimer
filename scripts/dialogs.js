	...
	switch (statNum) {
		...
		case 0:
			if (sessions[sesNum-1].length != 0) {
				...
				var statCon = "";
				calc_dlc();
				statCon += "session mean (" + document.getElementById("ses_not_dnf").innerHTML + "/" + sessions[sesNum - 1].length + "): " + document.getElementById("ses_mean").innerHTML + " (&sigma; = " + dlc.toFixed(2) + ")" + "<br>";
				for (var ind18 = 0; ind18 < sessions[sesNum - 1].length; ind18++) {
					statCon += (ind18 + 1) + ". " + sessions[sesNum - 1][ind18].strng + " &emsp; " + sessions[sesNum - 1][ind18].trao + "<br>";
				};
		...
		case 1:
			if (sessions[sesNum-1].length != 0) {
				document.getElementById("stat_dialog").style.display = "block";
				var statCon = "";
				statCon += "single: " + sessions[sesNum - 1][sessions[sesNum - 1].length - 1].strng + "<br>";
				statCon += "1. " + sessions[sesNum - 1][sessions[sesNum - 1].length - 1].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 1].trao + "<br>";
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 3:
			if (sessions[sesNum-1].length >= 3) {
				...
				for (var ind14 = 1; ind14 <= 3; ind14++) {
					statCon += ind14 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 4 + ind14].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 4 + ind14].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 5:
			if (sessions[sesNum-1].length >= 5) {
				...
				for (var ind16 = 1; ind16 <= 5; ind16++) {
					statCon += ind16 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 6 + ind16].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 6 + ind16].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 12:
			if (sessions[sesNum-1].length >= 12) {
				...
				for (var ind24 = 1; ind24 <= 12; ind24++) {
					statCon += ind24 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 13 + ind24].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 13 + ind24].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 50:
			if (sessions[sesNum-1].length >= 50) {
				...
				for (var ind32 = 1; ind32 <= 50; ind32++) {
					statCon += ind32 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 51 + ind32].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 51 + ind32].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 100:
			if (sessions[sesNum-1].length >= 100) {
				...
				for (var ind40 = 1; ind40 <= 100; ind40++) {
					statCon += ind40 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 101 + ind40].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 101 + ind40].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
	    ...
	    case 200:
	    	if (sessions[sesNum-1].length >= 200) {
				...
				for (var ind60 = 1; ind60 <= 200; ind60++) {
					statCon += ind60 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 201 + ind60].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 201 + ind60].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 500:
			if (sessions[sesNum-1].length >= 500) {
				...
				for (var ind62 = 1; ind62 <= 500; ind462++) {
					statCon += ind62 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 501 + ind62].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 501 + ind62].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
		...
		case 1000:
			if (sessions[sesNum-1].length >= 1000) {
				...
				for (var ind64 = 1; ind64 <= 1000; ind64++) {
					statCon += ind64 + ". " + sessions[sesNum - 1][sessions[sesNum - 1].length - 1001 + ind64].strng + " &emsp; " + sessions[sesNum - 1][sessions[sesNum - 1].length - 1001 + ind64].trao + "<br>";
				};
				document.getElementById("stats").innerHTML = statCon;
			}
			break;
