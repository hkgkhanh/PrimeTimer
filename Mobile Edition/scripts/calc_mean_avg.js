//##### CALCULATE MEAN AND AVERAGE #####
			...
			function calc_ao5() {
				...
				document.getElementById("q_cur_ao5").innerHTML = avg5strngArray[avg5strngArray.length - 1];
				document.getElementById("q_best_ao5").innerHTML = bestAvg5strng;
			};
			...
			function calc_ao12() {
				...
				document.getElementById("q_cur_ao12").innerHTML = avg12strngArray[avg12strngArray.length - 1];
				document.getElementById("q_best_ao12").innerHTML = bestAvg12strng;
			};
