...
var scramble_222 = (function(circle, rn) {
	...
	function getEGScramble(){
		return getScramble('222eg');
	}

	function getEG0Scramble(){
		return getScramble('222eg0');
	}

	function getEG1Scramble(){
		return getScramble('222eg1');
	}

	function getEG2Scramble(){
		return getScramble('222eg2');
	}

	return {
		getRandomScramble: getRandomScramble,
		getOptimalScramble: getOptimalScramble,
		getEGScramble: getEGScramble,
		getEG0Scramble: getEG0Scramble,
		getEG1Scramble: getEG1Scramble,
		getEG2Scramble: getEG2Scramble
	};
